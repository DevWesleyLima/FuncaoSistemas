...
namespace FI.AtividadeEntrevista.BLL
{
    public class BoBeneficiario
    {
        ...
        /// </summary>
        public List<DML.Beneficiario> GetListBeneficiariosByIDCliente(long IDCliente)
        {
            DAL.DaoBeneficiario cli = new DAL.DaoBeneficiario();
            return cli.GetListBeneficiariosByIDCliente(IDCliente);
        }

        /// <summary>
        /// Lista os beneficiarios
        /// </summary>
        public List<DML.Beneficiario> GetListSemPaginacao(string campoOrdenacao, bool crescente, out int qtd)
        {
            DAL.DaoBeneficiario cli = new DAL.DaoBeneficiario();
            return cli.GetListSemPaginacao(campoOrdenacao, crescente, out qtd);
        }
