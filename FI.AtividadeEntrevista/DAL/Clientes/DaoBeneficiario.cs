...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal List<Beneficiario> GetListBeneficiariosByIDCliente(long IDCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", IDCliente));

            DataSet ds = base.Consultar("FI_SP_GetListBeneficiariosByIDCliente", parametros);
            List<DML.Beneficiario> cli = Converter(ds);
            return cli;
        }
            

        internal List<Beneficiario> GetListSemPaginacao(string campoOrdenacao, bool crescente, out int qtd)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
